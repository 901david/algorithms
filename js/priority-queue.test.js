...
describe("Priority Queue", () => {
  ...
  describe("Enqueue", () => {
    ...
    describe("Dequeue", () => {
      test.skip("should correctly dequeue an element when 1 element present", () => {
        const pq = new PriorityQueue();
        const data = { data: "Helloo World", priority: 3 };
        pq.enqueue(data);
        expect(pq.size).toEqual(1);
      ...
      test.skip("should correctly dequeue an element when multiple elements present and maintain list", () => {
        const pq = new PriorityQueue();
        const dataOne = { data: "Helloo World", priority: 3 };
        const dataTwo = { data: "test", priority: 1 };
        const dataThree = { data: "test beginning", priority: 5 };
